...
layer5 = pd.read_csv(r'Grecian_Computer - Data with placeholder zeroes.csv', names=['A','B','C','D','E','F','G','H','I','J','K','L'], skiprows = lambda x: x not in layer5rows)
print("Layer 5:")
print(layer5)
print("")
layer4 = pd.read_csv(r'Grecian_Computer - Data with placeholder zeroes.csv', names=['A','B','C','D','E','F','G','H','I','J','K','L'], skiprows = lambda x: x not in layer4rows)
print("Layer 4:")
print(layer4)
print("")
layer3 = pd.read_csv(r'Grecian_Computer - Data with placeholder zeroes.csv', names=['A','B','C','D','E','F','G','H','I','J','K','L'], skiprows = lambda x: x not in layer3rows)
print("Layer 3:")
print(layer3)
print("")
layer2 = pd.read_csv(r'Grecian_Computer - Data with placeholder zeroes.csv', names=['A','B','C','D','E','F','G','H','I','J','K','L'], skiprows = lambda x: x not in layer2rows)
print("Layer 2:")
print(layer2)
print("")
layer1 = pd.read_csv(r'Grecian_Computer - Data with placeholder zeroes.csv', names=['A','B','C','D','E','F','G','H','I','J','K','L'], skiprows = lambda x: x not in layer1rows)
print("Layer 1:")
print(layer1)
print("")
